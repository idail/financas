...
class RapidoDespesas extends StatefulWidget {
  var _altura, _largura, _nomebusca, _idcat;

  RapidoDespesas(altura, largura, nomebusca, idcat) {
    _altura = altura;
    _largura = largura;
  ...
  @override
  RapidoDespesasState createState() => RapidoDespesasState();

}

class RapidoDespesasState extends State<RapidoDespesas> {
                    ...
                    child: InkWell(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text("Cadastrar Despesas"), // text
                        ],
                      ),
                    ),
                  ),
